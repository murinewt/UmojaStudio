...
<?php
     if(isset($_POST['createAccountAdmin'])){
        ...
        $accountSql = "INSERT INTO umojaadmin(firstName,otherName,username,phone,email,password,authKey) VALUES ('$surnameAcc','$othernameAcc','$username','$phoneAcc','$emailAcc','$encPass','$aukey')";
        $checkUsername = "SELECT * FROM umojaadmin WHERE email='$emailAcc'";
...
<body>
    ...
    <div class="register-photo">
        <div class="form-container" style="width:950px;">
            ...
            <form name="loginPage" method="post" style="width:420px;">
                ...
                <div class="form-row form-group">
                    <div class="col"><input class="form-control" type="text" name="username" required="" placeholder="username"></div>
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit" onsubmit="return validateF()" name="createAccountAdmin" style="background-color:rgb(239,120,11);">Sign Up</button></div><a href="#" class="already">You already have an account? Login here.</a></form>
        </div>
    </div>
 ...
 <script type='text/javascript'>
            function validateF(){
                ...
                var x5 = document.forms["loginPage"]["username"].value;
                if (x5 == null || x5 == "") {
