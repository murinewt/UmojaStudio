...
<body>
    ...
    <div class="row" style="min-height:100%;">
        ...
        <div class="col-md-8">
            <div class="row" style="padding:15px 0px;">
                <div class="col">
                    <h2 class="d-flex justify-content-center" style="color:rgb(0,0,255);">Admin Dashboard<br /></h2>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col align-self-center" style="background-color:rgb(237,237,237);margin:0px 10px;"><span><i class="fa fa-bookmark-o d-inline d-flex justify-content-center" style="font-size:100px;background-color:rgba(255,184,0,0);color:rgb(32,205,195);"></i></span>
                        ...
                        <p class="text-center" style="font-size:30px;color:rgb(0,0,255);"><a href="bookings.php">Bookings</a></p>
                    </div>
            ...
            <hr />
            <div class="container">
            <h3 style="color:rgb(0,0,255);">Users</h3>
                    ...
                    <tbody>
                            ...
                            <?php
                                ...
                                while($getThat = mysqli_fetch_array($passresult)){
                                    echo "<tr>";
                                    $email = $getThat['email'];
                                    $name1 = $getThat['firstName'];
                                    $name2 = $getThat['otherName'];
                                    $county = $getThat['county'];
                                    $phone = $getThat['phone'];
                                    echo "<td>".$name1."</td>";
                                    echo "<td>".$name2."</td>";
                                    echo "<td>".$email."</td>";
    ...
    <div class="header-blue" style="padding-bottom:20px;">
        <div class="container">
            <h1 class="text-center" style="color:rgb(255,255,255);">Admin Home Page</h1>
        </div>
    </div>
