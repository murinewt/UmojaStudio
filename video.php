...
<body>
    ...
    <div class="container">
        <div class="search-container"><input type="text" name="search-bar" placeholder="Search..." class="search-input"><button class="btn btn-light search-btn" type="button"> <i class="fa fa-search"></i></button></div>
    </div>
    <div class="container-fluid" class="" id="dqv">
            ...
            <?php
                       ...
                       // $userInt=$_SESSION["sess_user"];
                        ...
                        while($row=mysqli_fetch_array($result)){
                                ...
                                echo "<video controls style='padding-bottom:20px'><source src='video/".$row['name']."' type='video/mp4'>error</video>";
